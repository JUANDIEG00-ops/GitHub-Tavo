...
// 01. Declaración de Constantes (Datos del Aprendiz)
const NOMBRE_APRENDIZ = "Tu Nombre Completo"; // Remplaza esto
const NUMERO_FICHA = "1234567"; // Remplaza esto

// 02. Registro de Notas (Array con tres calificaciones)
...
// Usamos el método .reduce() para sumar todas las notas y luego dividimos por la cantidad de notas.
...
// Usamos .join(', ') para mostrar las notas como una cadena separada por comas
